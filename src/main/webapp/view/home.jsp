	...
	<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="nav navbar-nav  navbar-right" style="margin-left: 630px;">
          ...
          <li class="nav-item">
            <a class="nav-link" href="http://omkarsh.com/ResumeUpdated.pdf" target="_blank">Resume</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://github.com/OmkarShivadekar" target="_blank">Github</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://www.linkedin.com/in/omkarsh87/" target="_blank">Linkedin</a>
          </li>
        </ul>
